...
<head>
    ...
    <link rel="stylesheet" href="../../styles/specificRecord.css">
...
<body>
   ...
   // $sql = "INSERT INTO feedback (user_ID, feedback_info) VALUES ('U3', '$feedbackText')";

   // mysqli_query($link, $sql);
   // $userID = 4;

    //$viewFeedback = "SELECT feedback_info FROM feedback WHERE user_ID = '$userID'";

   // $feedbackInfo = mysqli_query($link, $viewFeedback);
    
   // $view = mysqli_fetch_assoc($feedbackInfo);
   // $viewFeedback = "SELECT feedback_info FROM feedback WHERE user_ID = 'U1'";
    ?>
