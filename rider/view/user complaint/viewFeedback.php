            ...
            <div class="container" id="container">
                ...
                <?php 
                        ...
                        include '../connectDB.php';
                                ...
                                $view = "SELECT feedback_info FROM feedback WHERE complaint_ID = '$i'";
                                $result = mysqli_query($link, $view);
                                if (mysqli_query($link, $view)) {
                                
                                    $row = mysqli_fetch_assoc($result);

                                    if(!isset($row["feedback_info"])){
                                    echo "<h3>Feedback</h3>
                                         <p>No feedback yet</p>
                                         <input type='submit' value='Back' id='Btn'>";}
                                    else{
                                              echo "<h3>Feedback</h3>
                                    <p>".$row['feedback_info']."</p>
                                         <input type='submit' value='Back' id='Btn'>";
                            
                                         }
                                   
                                } else {
                                    echo "Error on view feedback: " . mysqli_error($link);
                                }
