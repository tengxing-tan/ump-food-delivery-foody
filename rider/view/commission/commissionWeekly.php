...
<head>
    ...
    <link rel="stylesheet" href="../../styles/commissionWeekly.css">
...
<body>
    ...
    <div id="content-wrapper">
        ...
        <div id="main-content">
            ...
            <div id="topButton">
                <button id="weekly">Weekly Comission</button>
            ...
            <!--Select order and calculate weekly commission (assume commission is RM5 per order) -->
            <?php
           include '../connectDB.php';
           session_start();
           $rider = $_SESSION["rider"];

            $sql = "SELECT COUNT(`order_date`), `order_date`, WEEK(`order_date`), `order_status` FROM `order` WHERE rider_ID = '$rider' AND order_status = 'Completed' GROUP BY WEEK(`order_date`) ORDER BY WEEK(`order_date`) DESC";
            $result = mysqli_query($link, $sql);?>

            <div id="commDetail">
                <div id="topD">
                    <div id="item1" class="item1"><h3 id="topic1">Weeks</h3>
                    </div>
                ...
                <div id="middleD">
                    ...
                    <?php   
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            {
                            echo "
                        <li><p class='date'>".$row['WEEK(`order_date`)']."</p>
            ...
            <div id="average">
                    <p>Average Weekly Commission : </p><p id="avg">RM <?php echo $avg?></p>
                </div>
        </div>
    </div>
</body>
