        ...
        <?php 
            ...
            echo " <div class='container' id='container'>
                        <form id='feedbackF' action='complaint.php' method='get'>
                            <div id='topic'>
                                <h3>Error! You didn't enter any text or enter wrong format!</h3>
                                <p></p>
               ...
               // $sql = "UPDATE complaintlist SET feedback_info ='$feedbackText' WHERE complaint_ID = '$id'";
               $sql = "UPDATE feedback SET feedback_info ='$feedbackText'WHERE complaint_ID = '$id'";
